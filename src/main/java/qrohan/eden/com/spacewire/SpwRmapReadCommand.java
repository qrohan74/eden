...
/**
 * Class SpwRmapReadCommand
 * This represents the container: SpwRmapReadCommand
 * Description: Remote memory access protocol (ECSS-E-ST-50-52C) - Read Command
 */
public class SpwRmapReadCommand extends Container
{
    /**
     ...
     * @param parent parent container holding this field
     */
    public SpwRmapReadCommand(String name, Container parent)
    {
        super(name, parent);
    ...
    // --- END FIELDS METHODS ---
} // END OF CLASS SpwRmapReadCommand
