...
/**
 * Class SpwRmapReadReply
 * This represents the container: SpwRmapReadReply
 * Description: Remote memory access protocol (ECSS-E-ST-50-52C) - Read Reply
 */
public class SpwRmapReadReply extends Container
{
    /**
     ...
     * @param parent parent container holding this field
     */
    public SpwRmapReadReply(String name, Container parent)
    {
        super(name, parent);
